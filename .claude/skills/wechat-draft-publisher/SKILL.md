...
```bash
cd /root/.claude/skills/wechat-draft-publisher
...
- **HTML 处理**：参见 [scripts/fix-wechat-style.py](scripts/fix-wechat-style.py)
- **安装配置**：参见 [scripts/install.sh](scripts/install.sh)
