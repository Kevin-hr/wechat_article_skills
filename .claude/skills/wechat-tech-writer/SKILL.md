...
- **图片选择标准**：参见 [image-guidelines.md](references/image-guidelines.md)
- **AI生图技术**：参见 [ai-image-generation.md](references/ai-image-generation.md)
- **API配置**：参见 [api-configuration.md](references/api-configuration.md)
...
- [ ] 封面图已生成且文字为中文
- [ ] 所有链接为纯文本格式
- [ ] 字数符合类型要求（800-1500/2000-3000/1500-2500）
- [ ] 核心信息有权威来源支撑
- [ ] 禁止添加参考资料章节
- [ ] 标题 ≤64 字符
